...
const RegisterForm = () => {
  ...
  return (
    <form className="my-4" onSubmit={handleSubmit(() => console.log('User registered successfully'))}>
      <TextFormInput control={control} name="username" label="Username" placeholder="Enter username" containerClassName="form-group mb-2" />
        ...
        <Col xs={12}>
          <div className="form-check form-switch form-switch-success">
            ...
            <label className="form-check-label" htmlFor="customSwitchSuccess">
              By registering you agree to the Dastone{' '}
