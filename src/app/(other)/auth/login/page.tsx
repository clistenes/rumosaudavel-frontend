      ...
      <Card>
        <CardBody className="p-0 bg-black auth-header-box rounded-top">
          <div className="text-center p-3">
            ...
            <h4 className="mt-3 mb-1 fw-semibold text-white fs-18">Let&apos;s Get Started Dastone</h4>
            <p className="text-muted fw-medium mb-0">Sign in to continue to Dastone.</p>
          </div>
        </CardBody>
        <CardBody>
          <LoginForm />
