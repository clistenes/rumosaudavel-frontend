  ...
  if (activeChat) {
    ...
    return (
      <div className="chat-box-right">
        <div className="p-3 d-flex justify-content-between align-items-center card-bg rounded border-bottom">
              ...
              <div className="chat-features icons-center flex-nowrap">
                ...
                <a href="">
                  <button type="submit" role="button" className="btn p-0 text-primary">
                    <IconifyIcon icon="iconoir:send-solid" width={22} height={22} />
                  </button>
                </a>
              </div>
            </div>
