                      ...
                      <tr key={idx}>
                        ...
                        <td className="text-end">
                          <div className="img-group d-flex justify-content-end">
                            {document?.avatars &&
                              document?.avatars.map((avatar, idx) => (
                                <span role="button" className={clsx('user-avatar position-relative d-inline-block', { 'ms-n2': idx != 0 })} key={idx}>
                                  <Image src={avatar} alt="avatar" className="thumb-md shadow-sm rounded-circle" />
                                </span>
                              ))}
                          </div>
                        </td>
