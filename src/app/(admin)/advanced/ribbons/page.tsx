...
export const metadata: Metadata = { title: 'Ribbons' }

const Ribbons = () => {
  return (
    <>
    <PageTitle title='Ribbons' subName='Advanced UI' />
        ...
        <Col md={6}>
          <Card>
            ...
            <CardBody className="position-relative">
              <Row>
                <Col xs="auto">
                  <Image src={dastyle} alt="user" height={150} className="align-self-center shadow-sm mb-3 mb-lg-0" />
                </Col>
        ...
        <Col md={6}>
          <Card>
            ...
            <CardBody className="position-relative">
              <Row>
                <Col xs="auto">
                  <Image src={crovex} alt="user" height={150} className="align-self-center shadow-sm mb-3 mb-lg-0" />
                </Col>
                <Col className="align-self-center">
        ...
        <Col md={6}>
          <Card>
            ...
            <CardBody className="position-relative">
              <Row>
                <Col xs="auto">
                  <Image src={metrica} alt="user" height={150} className="align-self-center mb-3 shadow-sm mb-lg-0" />
                </Col>
                <Col className="align-self-center">
        ...
        <Col md={6}>
          <Card>
            ...
            <CardBody className="position-relative">
              <Row>
                <Col xs="auto">
                  <Image src={frogetor} alt="user" height={150} className="align-self-center mb-3 shadow-sm mb-lg-0" />
                </Col>
                <Col className="align-self-center">
        ...
        <Col md={6}>
          <Card>
            ...
            <CardBody className="position-relative">
              <Row>
                <Col xs="auto">
                  <Image src={dastyle} alt="user" height={150} className="align-self-center mb-3 shadow-sm mb-lg-0" />
                </Col>
                <Col className="align-self-center">
                  <p className="font-18 fw-semibold mb-2">Dastyle - Admin &amp; Dashboard Template</p>
                  <p className="text-muted">
        ...
        <Col md={6}>
          <Card>
            ...
            <CardBody className="position-relative">
              <Row>
                <Col xs="auto">
                  <Image src={crovex} alt="user" height={150} className="align-self-center mb-3 shadow-sm mb-lg-0" />
                </Col>
                <Col className="align-self-center">
                  <p className="font-18 fw-semibold mb-2">Crovex - Admin &amp; Dashboard Template</p>
                  <p className="text-muted">
