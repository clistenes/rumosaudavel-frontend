...
const Card1 = () => {
  return (
    <Card>
      <Image placeholder="blur" className="card-img-top img-fluid bg-light-alt" src={cardImg1} alt="Card image cap" />
      <CardHeader>
        <Row className="align-items-center">
          ...
          <Col xs="auto">
            <Image className="rounded-circle me-1" src={avatar7} alt="user-avatar" height={24} />
...
const Card4 = () => {
  return (
    <Card>
      ...
      <p className="card-footer bg-light-alt m-0">Footer - 2024 Dastone</p>
    </Card>
  )
}
  ...
  return (
    <Card>
      ...
      <CardBody className="pt-0">
        ...
        <Link href="" className="btn btn-outline-primary btn-sm me-1">
          Go somewhere
        </Link>
...
const Card6 = () => {
  return (
    <Card>
      <Row className="g-0">
        <Col md={4}>
          <Image src={cardImg2} className="img-fluid rounded-start" alt="..." />
        </Col>
        <Col md={8}>
          <CardBody>
  ...
  return (
    <Card>
      <Row className="g-0">
        ...
        <Col md={4}>
          <Image src={cardImg2} className="img-fluid rounded-end" alt="..." />
        </Col>
      </Row>
    </Card>
  )
  ...
  return (
    <CardGroup className="mb-3">
      {Array.from(new Array(Math.floor(3))).map((_card, idx) => (
        <Card key={idx}>
          <Image className="img-fluid bg-light-alt" src={cardImg3} alt="Card image" />
          <CardHeader>
    ...
    <Card className="mb-3">
      <Row className="g-0">
        <Col md={4} className="bg-light-alt align-self-center">
          <Image src={cardImg3} alt="..." className="img-fluid bg-light-alt" />
        </Col>
        <Col md={8}>
          <CardBody>
            <CardTitle>Card title</CardTitle>
...
const CardWithImage = () => {
  return (
    <Card>
      <Image src={cardImg3} width={306} height={114} className="card-img-top bg-light-alt" alt="..." />
      <CardBody>
        <CardTitle>Card title</CardTitle>
        <CardText>
...
const Cards = () => {
  return (
    <>
      <PageTitle title='Cards' subName='UI Ki' />
