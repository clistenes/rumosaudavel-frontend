...
export const metadata: Metadata = { title: 'Grids' }

const GridTable = () => {
  return (
    <ComponentContainerCard title="Grids">
      <div className="table-responsive">
        <Table className="table-bordered table-striped table-centered">
          <thead>
            <tr>
              <th scope="col" />
              <th scope="col">
...
const GridExample1 = () => {
  return (
    <ComponentContainerCard title="Grid-Example">
...
const Grids = () => {
  return (
    <>
      <PageTitle title='Grids' subName='UI Ki' />
