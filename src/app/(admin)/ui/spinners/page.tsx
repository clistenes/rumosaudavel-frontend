...
const BorderedSpinners = () => {
  return (
    <ComponentContainerCard title="Border Spinner">
      <Spinner />
...
const GrowingSpinner = () => {
  return (
    <ComponentContainerCard title="Growing Spinner">
      <Spinner type="grow" />
    </ComponentContainerCard>
  )
}
...
const ColorGrowingSpinners = () => {
  return (
    <ComponentContainerCard title="Color Growing spinner">
      {(colorVariants || []).map((color, idx) => {
...
const AlignmentSpinner = () => {
  return (
    <ComponentContainerCard title="Alignment">
...
const PlacementSpinners = () => {
  return (
    <ComponentContainerCard title="Placement">
...
const SpinnersSizes = () => {
  const sizes: ('md' | 'sm')[] = ['md', 'sm']
  return (
    <ComponentContainerCard title="Size">
      <Row>
        {(sizes || []).map((size, idx) => {
          return (
...
const ButtonSpinners = () => {
  return (
    <ComponentContainerCard title="Buttons spinners">
...
const CustomSpinners = () => {
  return (
    <ComponentContainerCard title="Custom spinners">
...
const CustomIconSpinners = () => {
  return (
    <ComponentContainerCard title="Custom Icon spinners">
      <Row>
        <Col md={3}>
...
const Spinners = () => {
  return (
    <>
    <PageTitle title='Spinners' subName='UI Ki' />
