...
const ListExample = () => {
  return (
    <ComponentContainerCard title="List Examples">
      <ListGroup>
        <ListGroupItem>
...
const ActiveItems = () => {
  return (
    <ComponentContainerCard title="Active Items">
      <ListGroup>
        <ListGroupItem>
...
const LinksAndButtons = () => {
  return (
    <ComponentContainerCard title="Links And Buttons">
      <ListGroup>
...
const FlushList = () => {
  return (
    <ComponentContainerCard title="Flush">
...
const ListWithBadges = () => {
  return (
    <ComponentContainerCard title="With Badges">
      <ListGroup>
...
const List = () => {
  return (
    <>
      <PageTitle title='Lists' subName='UI Ki' />
