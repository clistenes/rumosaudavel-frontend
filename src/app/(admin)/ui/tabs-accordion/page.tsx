...
export const metadata: Metadata = { title: 'Tabs and Accordions' }

const FlushExample = () => {
  return (
    <ComponentContainerCard title="Flush Example">
      <Accordion flush>
...
const AlwaysOpenAccordion = () => {
  return (
    <ComponentContainerCard title="Always Open">
...
const TabsAndAccordions = () => {
  return (
    <>
      <PageTitle title='Tab & Accordion' subName='UI Ki' />
      <AllTabs />
