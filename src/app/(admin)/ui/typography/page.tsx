...
const Heading = () => {
  return (
    <ComponentContainerCard title="Heading">
...
const DisplayHeading = () => {
  return (
    <ComponentContainerCard title="Display Heading">
...
const LeadExample = () => {
  return (
    <ComponentContainerCard title="Lead">
...
const InlineTextElements = () => {
  return (
    <ComponentContainerCard title="Inline text elements">
      <p>
...
const Blockquote = () => {
  return (
    <ComponentContainerCard title="Blockquote">
...
const UnOrderList = () => {
  return (
    <ComponentContainerCard title="UnOrder List">
      <ul className="mb-0">
...
const OrderList = () => {
  return (
    <ComponentContainerCard title="Order List">
      <ol className="mb-0">
        <li>Integer molestie lorem at massa</li>
...
const InlineList = () => {
  return (
    <ComponentContainerCard title="Inline List">
...
const TextColors = () => {
  return (
    <ComponentContainerCard title="Colors">
...
const ListAlignment = () => {
  return (
    <ComponentContainerCard title="Description List Alignment">
...
const Typography = () => {
  return (
    <>
      <PageTitle title='Typography' subName='UI Ki' />
            ...
            <Col md={6}>
              <Card>
                <CardBody>
                  ...
                  <h5 className="mb-0 fw-normal">Dastone</h5>
                </CardBody>
              </Card>
            </Col>
            <Col md={6}>
              <Card>
                <CardBody>
                  ...
                  <h5 className="mb-0 fw-bold">Dastone</h5>
                </CardBody>
              </Card>
            </Col>
          </Row>
