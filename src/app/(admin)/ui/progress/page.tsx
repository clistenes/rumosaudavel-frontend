...
const StripedAndAnimated = () => {
  return (
    <ComponentContainerCard title="Striped And Animated">
...
const LabelsAndMultipleBars = () => {
  return (
    <ComponentContainerCard title="Labels And Multiple Bars">
...
const HeightProgressBar = () => {
  return (
    <ComponentContainerCard title="Height">
...
const ProgressBars = () => {
  return (
    <>
    <PageTitle title='Progress' subName='UI Ki' />
