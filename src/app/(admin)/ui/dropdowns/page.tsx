...
const DefaultDropdown = () => {
  return (
    <ComponentContainerCard title="Default Dropdown">
...
const OutlineDropdown = () => {
  return (
    <ComponentContainerCard title="Outline Dropdown">
      <div className="d-flex flex-wrap gap-2">
        {colorVariants.map((color, idx) => {
          return (
            <Dropdown key={idx}>
...
const RoundedDropdowns = () => {
  return (
    <ComponentContainerCard title="Dropdown Rounded">
      <div className="d-flex flex-wrap gap-2">
        <Dropdown>
...
const RoundedOutlineDropdowns = () => {
  return (
    <ComponentContainerCard title="Dropdown Outlinez Rounded">
      <div className="d-flex flex-wrap gap-2">
        <Dropdown>
...
const DropdownSizing = () => {
  return (
    <ComponentContainerCard title="Dropdown Size">
...
const DropdownButtonAndLink = () => {
  return (
    <ComponentContainerCard title="Dropdown Button & Link">
      <Row className="g-2">
        <Col sm="auto">
          <Dropdown>
...
const DropUpVariationDropdowns = () => {
  return (
    <ComponentContainerCard title="Dropup Variation">
...
const DropEndVariationDropdowns = () => {
  return (
    <ComponentContainerCard title="Dropend Variation">
      <div className="d-flex flex-wrap gap-2 dropup">
        <Dropdown drop="end">
          <DropdownToggle variant="primary" type="button">
            {' '}
...
const MenuAlignmentDropdown = () => {
  return (
    <ComponentContainerCard title="Menu Alignment">
...
const DropStartVariation = () => {
  return (
    <ComponentContainerCard title="Dropstart Variation">
...
const Dropdowns = () => {
  return (
    <>
    <PageTitle title='Dropdowns' subName='UI Ki' />
