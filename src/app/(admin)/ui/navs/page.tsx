...
export const metadata: Metadata = { title: 'Navs' }

const BasicNav = () => {
  return (
    <ComponentContainerCard title="Base Nav">
      <Nav>
        <NavItem>
...
const NavTabs = () => {
  return (
    <ComponentContainerCard title="Nav Tabs">
...
const NavJustified = () => {
  return (
    <ComponentContainerCard title="Nav Justified">
...
const NavPills = () => {
  return (
    <ComponentContainerCard title="Nav Pills">
...
const NavTabsWithDropdowns = () => {
  return (
    <ComponentContainerCard title="Nav Tabs With Dropdowns">
...
const NavPillsWithDropdown = () => {
  return (
    <ComponentContainerCard title="Nav Pills With Dropdowns">
      <Nav defaultActiveKey={'0'} className="nav-pills">
        <NavItem>
          <NavLink eventKey={'0'}>Active</NavLink>
        </NavItem>
...
const Navs = () => {
  return (
    <>
    <PageTitle title='Navs' subName='UI Ki' />
