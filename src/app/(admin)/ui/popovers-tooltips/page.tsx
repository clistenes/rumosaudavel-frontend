...
export const metadata: Metadata = { title: 'Popovers and Tooltips' }

const placements: Placement[] = ['top', 'right', 'bottom', 'left']

const PopoversExample = () => {
  return (
    <ComponentContainerCard title="Popovers Example">
...
const BootstrapTooltips = () => {
  return (
    <ComponentContainerCard title="Bootstrap Tooltips">
      <div className="button-items d-flex flex-wrap gap-2">
        {placements.map((placement, idx) => {
          return (
            <OverlayTrigger key={idx} trigger={['hover', 'focus']} placement={placement} overlay={<Tooltip>Tooltip on {placement}</Tooltip>}>
...
const CustomAndDismissPopover = () => {
  return (
    <ComponentContainerCard title="Custom & Dismiss Popover">
      <div className="button-items d-flex flex-wrap gap-2">
        <OverlayTrigger
          trigger="click"
          placement="right"
...
const CustomTooltip = () => {
  return (
    <ComponentContainerCard title="Custom Tooltip">
      <div className="button-items d-flex flex-wrap gap-2">
        <OverlayTrigger
          trigger={['focus', 'hover']}
          placement="top"
          overlay={<Tooltip className="custom-tooltip">This top tooltip is themed via CSS variables.</Tooltip>}>
...
const PopoversAndTooltips = () => {
  return (
    <>
    <PageTitle title='Popovers And Tooltips' subName='UI Ki' />
