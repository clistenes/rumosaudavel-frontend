...
const OptionalSizes = () => {
  ...
  const { isTrue: defaultModalOpen, toggle: defaultModalToggle } = useToggle()
  const { isTrue: lgModalOpen, toggle: lgModalToggle } = useToggle()
  const { isTrue: xlModalOpen, toggle: xlModalToggle } = useToggle()
  const { isTrue: centerModalOpen, toggle: centerModalToggle } = useToggle()
  const { isTrue: scrollModalOpen, toggle: scrollModalToggle } = useToggle()
  return (
    <ComponentContainerCard title="Optional Sizes">
      ...
      <Modal
        ...
        <div className="text-center py-3">
          <Image src={avatar5} alt="avatar" className="thumb-lg rounded-circle d-block mx-auto mb-1" />
        ...
        <ModalBody>
          <Row>
            <Col lg={3} className="text-center align-self-center">
              <Image src={btcImage} alt="avatar" className="img-fluid" />
            </Col>
            <Col lg={9}>
        ...
        <ModalBody>
          <Row>
            <Col lg={4} className="text-center">
              <Image src={findImage} alt="avatar" className="img-fluid" />
            </Col>
...
const FullscreenModals = () => {
  ...
  return (
    <ComponentContainerCard title="Fullscreen Modal">
      <div className="table-responsive">
        <Table className="table-bordered table-striped mb-0">
          <thead>
            <tr>
...
const ThemesModal = () => {
  ...
  return (
    <ComponentContainerCard title="Theme Color Modal">
      <div className="button-items d-flex flex-wrap gap-2">
        {colorVariants.slice(0, 7).map((color, idx) => (
          <Button key={idx} variant={color} onClick={() => openModalWithClass(color)}>
