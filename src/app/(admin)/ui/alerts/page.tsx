...
const DefaultAlerts = () => {
  return (
    <ComponentContainerCard title="Default Alerts">
...
const DismissibleAlerts = () => {
  return (
    <ComponentContainerCard title="Dismissible Alerts">
...
const DismissibleOutlineAlerts = () => {
  return (
    <ComponentContainerCard title="Dismissible Outline Alerts">
...
const CustomIconAlerts = () => {
  return (
    <ComponentContainerCard title="Custom Icon Alerts">
...
const AdditionalContent = () => {
  return (
    <ComponentContainerCard title="Additional Content">
...
const Alerts = () => {
  return (
    <>
    <PageTitle title='Alerts' subName='UI Ki' />
