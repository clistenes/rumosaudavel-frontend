...
const data = {
  questionarios: [
    {
      title:
        "questionários cadastrados (onde estão os questionários cadastrados e como eles são listados.)",
      link: "https://www.youtube.com/embed/rJoz6sbVIu8?si=-XeLcZjD2VTEZZ-s",
    },
    {
      title:
        "visualizar questionário (como visualizar um questionário e quais são as opções de controle)",
      link: "https://www.youtube.com/embed/2cJiRt8piPM?si=vLQjA_cswFyMjEjO",
    },
    {
      title:
        "cadastrar questionário (como cadastrar um questionário e adicionar perguntas variadas)",
      link: "https://www.youtube.com/embed/TQss2y-8xKE?si=599P4KR-A1PgFLYi",
    },
    {
      title:
        "apagar e recuperar questionário (como apagar e recuperar questionários?)",
      link: "https://www.youtube.com/embed/7JjS1BDl2CA?si=Yf2TKH9WzmqwWqM-",
    },

    {
      title:
        "nova pergunta (como cadastrar uma pergunta em um questionário pronto)",
    ...
    {
      title:
        "pergunta dependente (como criar perguntas vinculadas à hipóteses)",
  ...
  programas: [
    ...
    {
      title:
        "configurar intervalo (intervalo que o programa está disponível para a empresa)",
  ...
  empresas: [
    {
      title:
        "nova empresa (como cadastrar empresas: cor, logotipo e campos personalizados)",
      link: "https://www.youtube.com/embed/VLOZlFetaTU",
    },
    {
      title:
        "visualizar e editar empresas (como cadastrar empresas: cor, logotipo e campos personalizados)",
      link: "https://www.youtube.com/embed/HKpeSHi3JBY",
    },
    {
      title:
        "novos logins (acessos de participntes) (como cadastrar logins e controlar acessos)",
  ...
  areaAdm: [
    ...
    {
      title:
        "usuário administrativo e controle (como criar novos acessos, alterar o cadastro, senha e excluir usuários adm)",
