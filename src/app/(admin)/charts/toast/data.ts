...
const theme5 = {
  ...
  series: {
    colors: ['#6f6af8', '#1ccab8', '#16cdc7', '#ecedf1'],
  },
}
...
const theme7 = {
  ...
  series: {
    colors: ['#6f6af8', '#1ccab8', '#16cdc7', '#ef4586', '#f1b44c'],
  },
}
...
const theme9 = {
  ...
  series: {
    colors: ['#22c55e', '#1ccab8', '#fac146', '#ef4586'],
...
const theme10 = {
  ...
  series: {
    colors: ['#6f6af8', '#1ccab8', '#16cdc7', '#ef4586'],
...
const theme11 = {
  ...
  series: {
    colors: ['#22c55e', '#1ccab8', '#fac146', '#ecedf1'],
  },
}
...
const bubbleChartOpts = {
  ...
  options: {
    ...
    chart: {
      ...
      format: function (value: string, valueType: string) {
