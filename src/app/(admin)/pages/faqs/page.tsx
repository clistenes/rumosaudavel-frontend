...
const QuestionWithAccordion = () => {
  return (
    <ComponentContainerCard title="Questions With Accordion">
...
const FAQs = () => {
  ...
  return (
    <>
    <PageTitle title='FAQ' subName='Pages' />
            ...
            <CardBody className="pt-0">
              <Row>
                {faqChunks.map((chunk, idx) => (
                  <Col lg={6} key={idx}>
                    {chunk.map((faq, idx) => (
                      <div className="p-4 rounded mb-3 border-dashed border-theme-color" key={idx}>
                        <div className="mb-2">
