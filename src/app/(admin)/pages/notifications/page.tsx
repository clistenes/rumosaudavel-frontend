...
const Notifications = () => {
  return (
    <>
    <PageTitle title='Notifications' subName='Pages' />
            ...
            <Row>
              <Col>
                ...
                <p className="text-body fs-14 ">
                  Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical <br /> Latin literature from
        ...
        {Object.keys(notifications).map((day, idx) => {
          return (
            <Fragment key={idx}>
              ...
              {notifications[day].map((notification, idx) => (
                <Card key={idx}>
                  <CardBody>
                    <Row>
                      <Col md={10}>
                        <span role="button">
                          <div className="d-flex align-items-center">
                            <div className="flex-shrink-0">
                              <Image src={notification.avatar} alt="avatar" className="thumb-lg rounded-circle" />
                            </div>
