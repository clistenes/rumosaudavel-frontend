...
export const metadata: Metadata = { title: 'Basic Action Email' }

const BasicActionEmail = () => {
  return (
    <>
    <PageTitle title='Basic' subName='Email Tem.' />
                      ...
                      <tr style={{ fontFamily: '"Helvetica Neue",Helvetica,Arial,sans-serif', boxSizing: 'border-box', fontSize: 14, margin: 0 }}>
                        <td
                          ...
                          <meta
                            ...
                            style={{ fontFamily: '"Helvetica Neue",Helvetica,Arial,sans-serif', boxSizing: 'border-box', fontSize: 14, margin: 0 }}
                          />
                          <table
                            width="100%"
                            cellPadding={0}
                                ...
                                <td>
                                  <a href="#">
                                    <Image
                                      ...
                                      src={logoSm}
                                      alt="logo"
                                      style={{ marginLeft: 'auto', marginRight: 'auto', display: 'block', marginBottom: 10, height: 40 }}
                                    />
                                  </a>
                                </td>
                              </tr>
