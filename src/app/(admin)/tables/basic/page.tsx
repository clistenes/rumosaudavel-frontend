        ...
        <Table className="mb-0 table-centered">
          ...
          <tbody>
            {basicTableData.map((item, idx) => (
              <tr key={idx}>
                <td>
                  <Image src={item.logo} alt="avatar" className="rounded-circle thumb-md me-1 d-inline" />
                  {item.name}
                </td>
                <td>{item.bill}</td>
                <td>
...
const BorderedTable = () => {
  return (
    <ComponentContainerCard title="Bordered Table">
      <div className="table-responsive">
        <Table className="table-bordered mb-0 table-centered">
          <thead>
            <tr>
      ...
      <Table striped className="table mb-0">
        ...
        <tbody>
          {stripedRowTableData.map((item, idx) => (
            <tr key={idx}>
              <td>
                <Image src={item.avatar} alt="avatar" className="rounded-circle thumb-md me-1 d-inline" /> Aaron Poulin
              </td>
              <td>{item.email}</td>
              <td>{item.phoneNo}</td>
              <td className="text-end">
...
const BasicTables = () => {
  return (
    <>
    <PageTitle title='Basic' subName='Tables'/>
