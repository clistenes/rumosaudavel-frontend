...
const TextualInputs = () => {
  return (
    <ComponentContainerCard title="Textual inputs">
      <Row>
        <Col lg="6">
          <Row className="mb-3">
...
const CustomStyles = () => {
  return (
    <ComponentContainerCard title="Custom Styles">
      <form>
        <Row>
          <Col md={4}>
            <div className="mb-3">
...
const FormControls = () => {
  return (
    <ComponentContainerCard title="Form Controls">
      <form>
        <div className="mb-3">
...
const InlineForm = () => {
  return (
    <ComponentContainerCard title="Inline Form">
...
const InputSizes = () => {
  return (
    <ComponentContainerCard title="Input Size">
      <form>
...
const FileBrowser = () => {
  return (
    <ComponentContainerCard title="File Browser">
...
const Switches = () => {
  return (
    <ComponentContainerCard title="Switches">
      <Row>
        <Col lg={4}>
...
const Checkboxes = () => {
  return (
    <ComponentContainerCard title="Checkboxes">
      <form className="form">
        <Row className="mb-3">
...
const Radios = () => {
  return (
    <ComponentContainerCard title="Radios">
      <form className="form">
        <Row className="mb-3">
...
const Range = () => {
  return (
    <ComponentContainerCard title="Range">
...
const InputGroupsStatic = () => {
  return (
    <ComponentContainerCard title="Input Groups Static">
      <div className="input-group mb-3">
...
const InputGroupsButtons = () => {
  return (
    <ComponentContainerCard title="Input Groups Buttons">
      <form>
...
const BasicElements = () => {
  return (
    <>
    <PageTitle title='Elements' subName='Forms' />
