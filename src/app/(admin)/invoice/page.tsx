...
const Invoice = () => {
  return (
    <>
      <PageTitle title='Invoice' subName='Apps' />
      <Row>
        <Col xs={12}>
          <Card>
            <CardBody className="bg-black">
              <Row>
                <Col xs={4} className="align-self-center">
                  <Image src={logoSm} alt="logo-small" className="logo-sm me-1" height={70} />
                </Col>
              ...
              <Row>
                ...
                <Col lg={6} className="align-self-center">
                  <div className="float-none float-md-end" style={{ width: '30%' }}>
                    ...
                    <Image src={signature} alt="signature" className="mt-2 mb-1" height={24} />
