...
export const metadata: Metadata = { title: 'Iconoir Icons' }

const IconoirIcons = () => {
  return (
    <>
    <PageTitle title='Iconoir' subName='Icons'/>
              ...
              <Row>
                <Col>
                  ...
                  <p className="text-muted mb-0 fs-14">
                    A high-quality selection of free icons. Your new alternative to Noun Project, Flaticon, and all Figma resources. Available in SVG,
